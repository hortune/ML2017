...
datagen.fit(x_train)
model2.fit_generator(datagen.flow(x_train,y_train,batch_size=128),steps_per_epoch=len(x_train)/8,epochs=500)
#model2.fit(x_train,y_train,batch_size=100,epochs=20,validation_split=0.1)
model2.save('68xxx_v2_cl5_model')
...
file_name = open('predict_cl5.csv','w')
