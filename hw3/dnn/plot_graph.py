...
ax1.plot(list(range(1,21)),train_accur,color="red",label="train",lw=2)
ax1.plot(list(range(1,21)),valid_accur,color="blue",label="validation",lw=2)
...
ax2.plot(list(range(1,21)),train_accur,color="red",label="train",lw=2)
ax2.plot(list(range(1,21)),valid_accur,color="blue",label="validation",lw=2)
